 ...
 * {@link LibraryPHR.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link LibraryPHR#newInstance} factory method to
 * create an instance of this fragment.
 */
public class LibraryPHR extends Fragment {
     ...
     * @return A new instance of fragment LibraryPHR.
     */
    // TODO: Rename and change types and number of parameters
    public static LibraryPHR newInstance(String param1, String param2) {
        LibraryPHR fragment = new LibraryPHR();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (((AppCompatActivity)getActivity()).getSupportActionBar()!=null)
            ((AppCompatActivity)getActivity()).getSupportActionBar().setTitle("PHR Library");
        else

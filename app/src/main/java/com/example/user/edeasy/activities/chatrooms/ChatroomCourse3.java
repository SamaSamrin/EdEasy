...
public class ChatroomCourse3 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chatroom_course3);
        ...
        Log.e(TAG, "#58 : department = "+department);
        ...
        messageInput = (EditText) findViewById(R.id.course3_message_input);
        conversationList = (ListView) findViewById(R.id.course3_chatroom_list);

...
public class ChatroomCourse4 extends Activity {


    private final String TAG = "** Chatroom Course 4**";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chatroom_course4);
        ...
        Log.e(TAG, "#57 : department = "+department);
        ...
        messageInput = (EditText) findViewById(R.id.course4_message_input);
        conversationList = (ListView) findViewById(R.id.course4_chatroom_list);
